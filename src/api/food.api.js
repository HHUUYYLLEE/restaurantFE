...
export const checkARoom = (formData) =>
  applicationJSONInstance.patch('room/checkRoom/check', formData)
export const getAllRoomsHost = (params) =>
  applicationJSONInstance.get('room/getRoom/getRoomHost', { params })
export const updateARoom = (formData) =>
  applicationJSONInstance.put('room/updateRoom/update', formData)
